...
import { CheckCircle, XCircle, type LucideProps } from 'lucide-react';
import ConfigSection from './ConfigSection';

/** Inline GitHub SVG icon — compatible with ConfigSection's LucideIcon prop */
...
export default function GitHubStatus({
  ...
  return (
    <ConfigSection title="GitHub 同步状态" icon={GithubIcon} color="bg-zinc-500">
      <div
