...
import { message, Card, ConfigProvider } from 'antd';
    ...
    <ConfigProvider
      theme={{
        components: {
          ...
          Button: {
            primaryColorBg: 'var(--ant-blue-6)',
            primaryColorBorder: 'var(--ant-blue-6)',
            colorBgContainerDisabled: 'var(--ant-color-border)',
          },
        },
      }}
    >
